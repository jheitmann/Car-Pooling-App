...
<?php
    ...
    $rides = pg_query($con, "SELECT * FROM 	complete_ride cr, ride WHERE cr.client = '" . $_SESSION['email'] . "' AND ride.rideid = cr.rideid
    ...
    if (pg_num_rows($rides) == 0) { 
		echo " <section>
			<svg width='1000' height='100'>
				...
				<text x='60' y='70' font-family='Verdana' font-size='30' fill='blue'> You have no booked rides. </text>
